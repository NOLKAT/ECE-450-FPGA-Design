...
REM
REM Generated by Vivado on Sat Nov 08 20:33:19 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_maxmul2x2_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_maxmul2x2_vlog.prj -log xvlog.log
