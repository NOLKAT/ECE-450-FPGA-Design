...
HLS_SOURCES = ../../../../main_testbench.cpp ../../../../main.cpp
...
$(ObjDir)/main_testbench.o: ../../../../main_testbench.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_testbench.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_testbench.d

$(ObjDir)/main.o: ../../../../main.cpp $(ObjDir)/.dir csim.mk
