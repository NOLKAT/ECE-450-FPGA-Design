...
`ifndef MAXMUL2X2_REFERENCE_MODEL_SV
`define MAXMUL2X2_REFERENCE_MODEL_SV

class maxmul2x2_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(maxmul2x2_reference_model)
