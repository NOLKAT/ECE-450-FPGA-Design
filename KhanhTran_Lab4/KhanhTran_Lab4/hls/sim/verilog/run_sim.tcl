...
if {[file isfile maxmul2x2.autotvin.dat]} {
	file delete -force maxmul2x2.autotvin.dat
}

if {[file isfile maxmul2x2.autotvout.dat]} {
	file delete -force maxmul2x2.autotvout.dat
}
