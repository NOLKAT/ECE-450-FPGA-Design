...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.maxmul2x2.autotvin_a00.dat"
         "c.maxmul2x2.autotvin_a01.dat"
         "c.maxmul2x2.autotvin_a10.dat"
         "c.maxmul2x2.autotvin_a11.dat"
         "c.maxmul2x2.autotvin_b00.dat"
         "c.maxmul2x2.autotvin_b01.dat"
         "c.maxmul2x2.autotvin_b10.dat"
         "c.maxmul2x2.autotvin_b11.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.maxmul2x2.autotvout_c00.dat"
         "rtl.maxmul2x2.autotvout_c01.dat"
         "rtl.maxmul2x2.autotvout_c10.dat"
         "rtl.maxmul2x2.autotvout_c11.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
