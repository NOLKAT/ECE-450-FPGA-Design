...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "maxmul2x2.autotvin.dat"
	set constFileTvOut       "maxmul2x2.autotvout.dat"
	set constFileHdlTvIn     "maxmul2x2.autohdltvin.dat"
	set constFileHdlTvOut    "maxmul2x2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
