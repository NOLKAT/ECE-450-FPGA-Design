...
if {[file isfile mux_2to1.autotvin.dat]} {
	file delete -force mux_2to1.autotvin.dat
}

if {[file isfile mux_2to1.autotvout.dat]} {
	file delete -force mux_2to1.autotvout.dat
}
