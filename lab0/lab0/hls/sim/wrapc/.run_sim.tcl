...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mux_2to1.autotvin.dat"
	set constFileTvOut       "mux_2to1.autotvout.dat"
	set constFileHdlTvIn     "mux_2to1.autohdltvin.dat"
	set constFileHdlTvOut    "mux_2to1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
