...
HLS_SOURCES = ../../../../Tb_mux.cpp ../../../../Mux_2to1.cpp
...
$(ObjDir)/Tb_mux.o: ../../../../Tb_mux.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../Tb_mux.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/Tb_mux.d

$(ObjDir)/Mux_2to1.o: ../../../../Mux_2to1.cpp $(ObjDir)/.dir csim.mk
