...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "compute.autotvin.dat"
	set constFileTvOut       "compute.autotvout.dat"
	set constFileHdlTvIn     "compute.autohdltvin.dat"
	set constFileHdlTvOut    "compute.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
