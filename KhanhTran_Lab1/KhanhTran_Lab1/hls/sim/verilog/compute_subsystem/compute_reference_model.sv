...
`ifndef COMPUTE_REFERENCE_MODEL_SV
`define COMPUTE_REFERENCE_MODEL_SV

class compute_reference_model extends uvm_component;
    event allsvr_input_done;
    event allsvr_output_done;
    int trans_num_total = 205;
    int trans_num_idx;
    int ap_done_cnt=1;
    ...
    `uvm_component_utils_begin(compute_reference_model)
