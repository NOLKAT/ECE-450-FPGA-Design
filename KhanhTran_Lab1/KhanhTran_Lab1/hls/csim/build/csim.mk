...
HLS_SOURCES = ../../../../tb_compute.cpp ../../../../compute_c.cpp
...
$(ObjDir)/tb_compute.o: ../../../../tb_compute.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../tb_compute.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_compute.d

$(ObjDir)/compute_c.o: ../../../../compute_c.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../compute_c.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/compute_c.d
