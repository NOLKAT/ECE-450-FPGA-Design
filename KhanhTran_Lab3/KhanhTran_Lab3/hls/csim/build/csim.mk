...
HLS_SOURCES = ../../../../sobel_testbench.cpp ../../../../sobel.cpp
...
$(ObjDir)/sobel_testbench.o: ../../../../sobel_testbench.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../sobel_testbench.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sobel_testbench.d

$(ObjDir)/sobel.o: ../../../../sobel.cpp $(ObjDir)/.dir csim.mk
