...
if {[file isfile sobel_rgb_axis.autotvin.dat]} {
	file delete -force sobel_rgb_axis.autotvin.dat
}

if {[file isfile sobel_rgb_axis.autotvout.dat]} {
	file delete -force sobel_rgb_axis.autotvout.dat
}
