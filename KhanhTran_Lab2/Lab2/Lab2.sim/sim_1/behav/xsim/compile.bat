...
REM
REM Generated by Vivado on Fri Sep 26 21:57:54 -0400 2025
...
echo "xvlog --incr --relax -prj fir16_vlog.prj"
call xvlog  --incr --relax -prj fir16_vlog.prj -log xvlog.log
