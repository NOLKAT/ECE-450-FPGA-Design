...
using hls::sim::Byte;
extern "C" void fir16(Byte<2>*, Byte<4>*);
extern "C" void apatb_fir16_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y) {
using hls::sim::createStream;
  // Collect __xlx_x__tmp_vec
std::vector<Byte<2>> __xlx_x__tmp_vec;
for (size_t i = 0; i < 256; ++i){
__xlx_x__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_x)[i]);
}
  int __xlx_size_param_x = 256;
...
__xlx_y__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_y)[i]);
  ...
  int __xlx_size_param_y = 256;
  int __xlx_offset_param_y = 0;
  int __xlx_offset_byte_param_y = 0*4;
  // DUT call
  fir16(__xlx_x__tmp_vec.data(), __xlx_y__tmp_vec.data());
// print __xlx_apatb_param_x
for (size_t i = 0; i < __xlx_size_param_x; ++i) {
((Byte<2>*)__xlx_apatb_param_x)[i] = __xlx_x__tmp_vec[__xlx_offset_param_x+i];
}
