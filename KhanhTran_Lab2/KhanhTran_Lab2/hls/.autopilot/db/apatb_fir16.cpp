...
#define AUTOTB_TVOUT_x "../tv/cdatafile/c.fir16.autotvout_x.dat"
#define AUTOTB_TVIN_y "../tv/cdatafile/c.fir16.autotvin_y.dat"
#define AUTOTB_TVOUT_y "../tv/cdatafile/c.fir16.autotvout_y.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_y "../tv/rtldatafile/rtl.fir16.autotvout_y.dat"
...
extern "C"
void fir16_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_fir16_hw(void* __xlx_apatb_param_x, void* __xlx_apatb_param_y)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_y),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_y),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_y),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_y),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_y),
#else
  ...
  port1.param = { __xlx_apatb_param_y };
  port1.mname = { "y" };
  port1.nbytes = { 1024 };
  ...
  try {
    ...
    fir16_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_y);
