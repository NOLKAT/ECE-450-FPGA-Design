...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.fir16.autotvin_x.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.fir16.autotvout_x.dat"; 
//------------------------Local signal-------------------
...
initial begin : read_file_process
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      wait(initialed.triggered || dut2tb_ap_ready.triggered);
      wait(write_process_done.triggered);
        for(i = 0; i < DEPTH; i = i + 1) begin
...
initial begin : write_file_runtime_proc
	  integer fp;
    #1;
    @initialed;
	  fp = $fopen(TV_OUT, "wb");
