...
`ifndef FIR16_REFERENCE_MODEL_SV
`define FIR16_REFERENCE_MODEL_SV

class fir16_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(fir16_reference_model)
